$.terms('addTheme', 'bootstrap', function(settings){
    this.modal = $('<div class="modal fade"><div class="modal-dialog"><div class="modal-content">'+
                    '<div class="modal-header"><h4 class="modal-title">'+settings.title+'</h4></div>'+
    ...
    this.render = function(data){
        ...
        if($.isArray(data)){
            ...
            $.each(data, function(idx, val){
                ...
                if('desc' in val){
                    entry.find('.panel-title').append('<i class="fa-chevron-down fa fa-fw pull-right" style="margin-top:3px;"></i>').wrapInner('<a data-toggle="collapse" style="display:block;text-decoration:none;" href="#termsCollapse'+i+'" aria-controls="termsCollapse'+i+'" class="collapsed"></a>');
    ...
    this.in = function(){
        this.modal.modal('show').on('shown.bs.modal', function (e) {
